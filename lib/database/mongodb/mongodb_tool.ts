...
export default class MongodbTool {
  ...
  static span2qexpr<T>(span: Pair<T>): any {
    ...
    if(ArrayTool.listpair2eq_every_nativetri(span, [null,null])){ return {$exists:true}; } // any value
      ...
      if (ArrayTool.is_array(v0_in)) {
        ...
        const v0_outs_list:V[][] = Object.keys(v0_in).map((k1):V[] => {
          ...
          return ArrayTool.all([
            ...
            DictTool.is_dict(v1_in) && ArrayTool.listpair2eq_every_nativetri(Object.keys(v1_in), ["$elemMatch"]),
          ])
